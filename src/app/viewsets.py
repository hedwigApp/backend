...
class AppViewSet(MultiSerializerMixin, _ModelViewSet):
...
class AdminViewSet(AppViewSet):
    permission_classes = [permissions.IsAdminUser]


class AdminReadOnlyViewSet(ReadOnlyAppViewSet):
    permission_classes = [permissions.IsAdminUser]


class AnonReadOnlyAppViewSet(ReadOnlyAppViewSet):
